...
class Bentley(object):
    ...
    def compute_start_event(self, eve):
        ...
        # Si oui, on met à jour la liste des segments dans le croisement., ce qui mettra à jour également l'évènement associé!
    ...
    def compute_end_event(self, eve) :
        ...
        if i > 0 and i < len(self.alive_segments) - 1:
