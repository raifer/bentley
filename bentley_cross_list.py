...
# -*- coding: utf-8 -*-
"""
Ce module implémente l'algorithme de Bentley-Ottmann en stockant les intersections trouvées dans une liste, au lieu
d'un set.
"""
...
class BentleyCrossList(object):
    def __init__(self, filename=None, segments=None):
        ...
        self.cross_list = []
        self.cross_list_complet = []  # Set contenant aussi les croisements de type "contact"
    ...
    def traiter_croisement(self, cross, pas_contact):
        ...
        if cross and cross not in self.cross_list_complet:
            # Si le croisement n'est pas présent dans la liste complète, on l'y ajoute.
            self.cross_list_complet.append(cross)
